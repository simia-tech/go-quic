...
func TestVersionNegotitation(t *testing.T) {
	testCases := []struct {
		...
		{"One", 1, []uint32{1},
			[]byte{0x0d, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00}},
		{"Two", 1, []uint32{1, 2},
			[]byte{0x0d, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00}},
	}
